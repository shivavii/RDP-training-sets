...
while( my $curr = $ref_fasta_db->next_seq() ) {
	...
	if( (defined($k) && defined($p) && defined($c) && defined($o) && defined($f) && defined($g))
		&& ($k ne "k__" && $p ne "p__" && $c ne "c__" && $o ne "o__" && $f ne "f__" && $g ne "g__") ){
		$new_header .= $id." ".$k.";".$p.";".$c.";".$o.";".$f.";".$g.";";
		...
		my $newf = $f;
		$newf =~ s/f__//;
		$new_header .= $id." ".$k.";".$p.";".$c.";".$o.";".$f.";g__".$newf."FA;";
		print OUT $new_header."\n".$curr->seq."\n";
		...
		my $newo = $o;
		$newo =~ s/o__//;
		$new_header .= $id." ".$k.";".$p.";".$c.";".$o.";f__".$newo."OR;g__".$newo."OR;";
		print OUT $new_header."\n".$curr->seq."\n";
		...
		my $newc = $c;
		$newc =~ s/c__//;
		$new_header .= $id." ".$k.";".$p.";".$c.";o__".$newc."CL;o__".$newc."CL;f__".$newc."CL;g__".$newc."CL;";
		print OUT $new_header."\n".$curr->seq."\n";
		...
		my $newp = $p;
		$newp =~ s/p__//;
		$new_header .= $id." ".$k.";".$p.";c__".$newp."PH;o__".$newp."PH;o__".$newp."PH;f__".$newp."PH;g__".$newp."PH;";
		print OUT $new_header."\n".$curr->seq."\n";
		...
		my $newk = $k;
		$newk =~ s/k__//;
		$new_header .= $id." ".$k.";p__".$newk."KI;c__".$newk."KI;o__".$newk."KI;o__".$newk."KI;f__".$newk."KI;g__".$newk."KI;";
		print OUT $new_header."\n".$curr->seq."\n";
